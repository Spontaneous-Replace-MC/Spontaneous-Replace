...
import static SpontaneousReplace.SpiderBiome.Mobs.SprayPoisonSpider.Client.TOXIN_LAYER;
...
public class ToxinRenderer
     ...
     * 纹理路径
     */
    protected static final Identifier TEXTURE = new Identifier(MOD_ID, "textures/entity/spider/toxin.png");
    /**
     * 毒素模型
     */
