...
import static SpontaneousReplace.SpiderBiome.Mobs.WeavingWebSpider.Data.TARGET_RANGE;
import static SpontaneousReplace.SpiderBiome.Mobs.WeavingWebSpider.Data.WEAVE_TIME;

/**
 * <b style="color:FFC800"><font size="+2">Navigation：织网蜘蛛导航类</font></b>
...
public class Navigation extends MobNavigation {
    ...
    public void tick() {
        // 如果没有播放筑网动画
        if (mob instanceof Entity spider && spider.weaveAnimeTime >= WEAVE_TIME) {
            boolean flag = false;
