...
/**
 * <b style="color:FFC800"><font size="+2">Server：织网蜘蛛服务端注册器</font></b>
...
public abstract class Server {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.SPAWN_EGGS).register(content -> content.add(WEAVING_WEB_SPIDER_SPAWN_EGG));
    }
}