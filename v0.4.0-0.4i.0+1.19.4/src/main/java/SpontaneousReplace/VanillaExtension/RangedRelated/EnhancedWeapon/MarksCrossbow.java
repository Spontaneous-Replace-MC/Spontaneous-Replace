...
public class MarksCrossbow extends SRCrossbow {
    ...
    public MarksCrossbow(Settings settings) {
        super(settings, MARKS_CROSSBOW_PROJECTILES, USING_SPEED, MAX_USE_TIME, MAX_ARROW_SPEED, BASIC_DAMAGE_MULTIPLE, RANGE);
    }
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        if (world.isClient) {
            ...
            if ((mainHandStack.isOf(MARKS_CROSSBOW) && SRCrossbow.isCharged(mainHandStack))
    ...
    protected PersistentProjectileEntity createArrow(World world, LivingEntity entity, ItemStack crossbow, ItemStack arrow) {
        // 创建箭实体
        Item arrowItem = (Item) (arrow.getItem() instanceof Item ? arrow.getItem() : FULL_POWER_STEEL_ARROW);
     ...
     * 神臂弩装填开始音效 ID
     */
    public static final Identifier LOADING_START_ID = new Identifier(MOD_ID + ":vanilla_extension.marks_crossbow.loading.start");
    /**
     * 神臂弩装填开始音效
     */
     ...
     * 神臂弩装填中音效 ID
     */
    public static final Identifier LOADING_MIDDLE_ID = new Identifier(MOD_ID + ":vanilla_extension.marks_crossbow.loading.middle");
    /**
     * 神臂弩装填中音效
     */
     ...
     * 神臂弩装填结束音效 ID
     */
    public static final Identifier LOADING_END_ID = new Identifier(MOD_ID + ":vanilla_extension.marks_crossbow.loading.end");
    /**
     * 神臂弩装填结束音效
     */
     ...
     * 神臂弩发射音效 ID
     */
    public static final Identifier SHOOT_ID = new Identifier(MOD_ID + ":vanilla_extension.marks_crossbow.shoot");
    /**
     * 神臂弩发射音效
     */
     ...
     * 神臂弩快速装填Ⅰ音效 ID
     */
    public static final Identifier QUICK_CHARGE_1_ID = new Identifier(MOD_ID + ":vanilla_extension.marks_crossbow.quick_charge.1");
    /**
     * 神臂弩快速装填Ⅰ音效
     */
     ...
     * 神臂弩快速装填Ⅱ音效 ID
     */
    public static final Identifier QUICK_CHARGE_2_ID = new Identifier(MOD_ID + ":vanilla_extension.marks_crossbow.quick_charge.2");
    /**
     * 神臂弩快速装填Ⅱ音效
     */
     ...
     * 神臂弩快速装填Ⅲ音效 ID
     */
    public static final Identifier QUICK_CHARGE_3_ID = new Identifier(MOD_ID + ":vanilla_extension.marks_crossbow.quick_charge.3");
    /**
     * 神臂弩快速装填Ⅲ音效
     */
     ...
     * <p>耐久为弩的 3 倍</p>
     */
    public static final MarksCrossbow MARKS_CROSSBOW = new MarksCrossbow(new net.minecraft.item.Item.Settings().maxDamageIfAbsent(MAX_DAMAGE));
    ...
    public static void register() {
        // 注册神臂弩
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "marks_crossbow"), MARKS_CROSSBOW);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.EQUIPMENT).register(content -> content.add(MARKS_CROSSBOW));
        // 注册神臂弩谓词
        ...
        ModelPredicateProviderRegistry.register(MARKS_CROSSBOW, new Identifier("shootend"), (stack, world, entity, seed) -> {
            if (entity == null)
                return 0;
