...
public abstract class Items {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.INGREDIENTS).register(content -> content.add(AUCU_ALLOY));
        // 注册金铜锭
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "aucu_alloy_ingot"), AUCU_ALLOY_INGOT);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.INGREDIENTS).register(content -> content.add(AUCU_ALLOY_INGOT));
        // 注册金铜粒
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "aucu_alloy_nugget"), AUCU_ALLOY_NUGGET);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.INGREDIENTS).register(content -> content.add(AUCU_ALLOY_NUGGET));
    }
}