...
public abstract class Items {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.INGREDIENTS).register(content -> content.add(COPPER_FOR_SMELTING_INGOT));
        // 注册精铜锭
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "refined_copper_ingot"), REFINED_COPPER_INGOT);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.INGREDIENTS).register(content -> content.add(REFINED_COPPER_INGOT));
        // 注册精铜粒
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "refined_copper_nugget"), REFINED_COPPER_NUGGET);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.INGREDIENTS).register(content -> content.add(REFINED_COPPER_NUGGET));
    }
}
