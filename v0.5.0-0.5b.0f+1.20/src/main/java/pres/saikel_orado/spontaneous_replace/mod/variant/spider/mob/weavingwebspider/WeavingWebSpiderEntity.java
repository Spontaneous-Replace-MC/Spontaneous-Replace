...
import static pres.saikel_orado.spontaneous_replace.mod.variant.spider.mob.weavingwebspider.WeavingWebSpiderData.*;

/**
 * <b style="color:FFC800"><font size="+2">WeavingWebSpiderEntity：织网蜘蛛实体类</font></b>
 ...
 * | 创建于 2023/1/18 19:41
 */
public class WeavingWebSpiderEntity extends SRSpiderEntity {
    ...
    public WeavingWebSpiderEntity(EntityType<? extends SpiderEntity> entityType, World world) {
