...
import static pres.saikel_orado.spontaneous_replace.mod.data.SRElements.Variant.Spider.SPRAY_TOXIN;
import static pres.saikel_orado.spontaneous_replace.mod.variant.spider.mob.spraypoisonspider.SprayPoisonSpiderData.*;

/**
 * <b style="color:FFC800"><font size="+2">SprayPoisonSpiderEntity：喷吐毒蛛实体类</font></b>
 ...
 * | 创建于 2023/01/06
 */
public class SprayPoisonSpiderEntity extends SRSpiderEntity implements RangedAttackMob {
    protected final AnimationState sprayingAnimationState = new AnimationState();

    /**
     * 构建喷吐毒蛛
     */
    public SprayPoisonSpiderEntity(EntityType<? extends SpiderEntity> entityType, World world) {
