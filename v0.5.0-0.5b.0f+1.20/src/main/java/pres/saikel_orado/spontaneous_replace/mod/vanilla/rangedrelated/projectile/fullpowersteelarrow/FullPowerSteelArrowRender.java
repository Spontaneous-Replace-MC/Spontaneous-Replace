...
/**
 * <b style="color:FFC800"><font size="+2">FullPowerSteelArrowRender：全威力钢箭渲染类</font></b>
...
public class FullPowerSteelArrowRender extends EntityRenderer<FullPowerSteelArrowEntity> {
    public static final Identifier TEXTURE = new Identifier(SR_ID, "textures/entity/bullet/full_power_steel_arrow.png");

    public FullPowerSteelArrowRender(EntityRendererFactory.Context context) {
        super(context);
    }

    @Override
    public void render(FullPowerSteelArrowEntity entity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    @Override
    public Identifier getTexture(FullPowerSteelArrowEntity spectralArrowEntity) {
        return TEXTURE;
    }
}
