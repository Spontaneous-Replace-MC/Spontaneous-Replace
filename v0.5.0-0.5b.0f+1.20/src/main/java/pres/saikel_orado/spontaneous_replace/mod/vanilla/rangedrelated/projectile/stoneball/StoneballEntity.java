...
import static pres.saikel_orado.spontaneous_replace.mod.data.SRElements.Vanilla.RangedRelated.STONEBALL;
import static pres.saikel_orado.spontaneous_replace.mod.data.SRElements.Vanilla.RangedRelated.STONEBALL_ENTITY;
...
public class StoneballEntity extends ThrownItemEntity {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (punchLevel > 0 && entity instanceof LivingEntity)
            ((LivingEntity) entity).takeKnockback(punchLevel * 2, -velocity.getX(), -velocity.getZ());
