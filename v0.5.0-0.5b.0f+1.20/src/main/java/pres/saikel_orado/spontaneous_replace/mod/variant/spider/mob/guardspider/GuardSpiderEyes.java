...
/**
 * <b style="color:FFC800"><font size="+2">GuardSpiderEyes：蜘蛛卫兵眼部发光类</font></b>
...
public class GuardSpiderEyes<T extends SRSpiderEntity, M extends SRSpiderModel<T>> extends SRSpiderEyes<T, M> {
