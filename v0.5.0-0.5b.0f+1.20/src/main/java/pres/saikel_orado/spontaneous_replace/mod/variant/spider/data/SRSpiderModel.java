...
import static pres.saikel_orado.spontaneous_replace.java.Functions.toFloat;
import static pres.saikel_orado.spontaneous_replace.java.Functions.toRadians;

/**
 * <b style="color:FFC800"><font size="+2">SRSpiderModel：《自然更替》蜘蛛模型类</font></b>
 * <p><i><b style="color:FFC800"><font size="+1">《自然更替》蜘蛛的基础实体模型和基础动作分配</font></b></i></p>
 * <style="color:FFC800">
 *
...
public abstract class SRSpiderModel<S extends SRSpiderEntity> extends SinglePartEntityModel<S> {
     ...
     * @param root 根组件
     */
    public SRSpiderModel(ModelPart root) {
        this.root = root;
