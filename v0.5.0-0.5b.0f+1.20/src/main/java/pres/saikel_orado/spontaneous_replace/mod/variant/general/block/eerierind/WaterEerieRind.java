...
/**
 * <b style="color:FFC800"><font size="+2">WaterEerieRind：含水阴森木壳</font></b>
 * <p><i><b style="color:FFC800"><font size="+1">内部盛水的阴森木壳</font></b></i></p>
 * <style="color:FFC800">
 *
...
public class WaterEerieRind extends LeveledEerieRind implements EerieRindShapeFix {
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        ...
        if (neighborState.isAir()) {
            ...
            if (isFull(state))
                world.setBlockState(neighborPos, Blocks.WATER.getDefaultState(), 3);
        }
        ...
        if (neighborState.isOf(Blocks.CAULDRON)) {
            world.setBlockState(pos, EERIE_RIND.getDefaultState(), 3);
            world.setBlockState(neighborPos, Blocks.WATER_CAULDRON.getDefaultState().with(LeveledEerieRind.LEVEL, state.get(LeveledEerieRind.LEVEL)), 3);
        }
        return super.getStateForNeighborUpdate(state, direction, neighborState, world, pos, neighborPos);
    }
