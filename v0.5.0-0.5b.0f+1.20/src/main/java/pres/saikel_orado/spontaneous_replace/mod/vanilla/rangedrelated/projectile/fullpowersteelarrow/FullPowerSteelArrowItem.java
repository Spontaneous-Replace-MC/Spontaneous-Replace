...
/**
 * <b style="color:FFC800"><font size="+2">FullPowerSteelArrowItem：全威力钢箭</font></b>
 ...
 * | 创建于 2023/5/1 21:04
 */
public class FullPowerSteelArrowItem extends net.minecraft.item.Item {
    /**
     * 构建全威力钢箭
     */
    public FullPowerSteelArrowItem(Settings settings) {
        super(settings);
    }
    ...
    public PersistentProjectileEntity createArrow(World world, LivingEntity shooter) {
        return new FullPowerSteelArrowEntity(world, shooter);
    }
}
