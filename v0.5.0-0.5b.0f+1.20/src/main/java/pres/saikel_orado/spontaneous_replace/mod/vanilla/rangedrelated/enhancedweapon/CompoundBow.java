...
public class CompoundBow extends SRBow {
    ...
    public static final int COMPOUND_BOW_MAX_DAMAGE = Items.BOW.getMaxDamage() * 5;
    ...
    public CompoundBow(Settings settings) {
        super(settings,
                COMPOUND_BOW_PROJECTILES,
                COMPOUND_BOW_ENCHANTMENTS,
                DEFAULT_USING_SPEED,
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        // 获取使用物品
        ItemStack itemStack = new ItemStack(COMPOUND_BOW);
