...
public abstract class SRSpiderRenderer<S extends SRSpiderEntity> extends MobEntityRenderer<S, SRSpiderModel<S>> {
    /**
     * 注册渲染器
     *
     ...
     * @param shadow  阴影半径
     */
    public SRSpiderRenderer(EntityRendererFactory.Context context, SRSpiderModel<S> model, float shadow) {
