...
public abstract class Items {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.MISC).register(content -> content.add(CUFE_ALLOY));
        // 注册铜铁锭
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "cufe_alloy_ingot"), CUFE_ALLOY_INGOT);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.MISC).register(content -> content.add(CUFE_ALLOY_INGOT));
        // 注册铜铁粒
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "cufe_alloy_nugget"), CUFE_ALLOY_NUGGET);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.MISC).register(content -> content.add(CUFE_ALLOY_NUGGET));
    }
}
