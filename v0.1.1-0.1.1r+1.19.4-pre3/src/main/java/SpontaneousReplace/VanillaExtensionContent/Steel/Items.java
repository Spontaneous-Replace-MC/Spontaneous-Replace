...
public abstract class Items {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.MISC).register(content -> content.add(CLEAN_COAL));
        // 注册生铁
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "pig_iron"), PIG_IRON);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.MISC).register(content -> content.add(PIG_IRON));
        // 注册钢锭
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "steel_ingot"), STEEL_INGOT);
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.MISC).register(content -> content.add(STEEL_INGOT));
    }
}
