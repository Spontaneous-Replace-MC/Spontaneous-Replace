...
/**
 * <b style="color:FFC800"><font size="+2">Register：蜘蛛卫兵服务端注册器</font></b>
...
public abstract class Register {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.MISC).register(content -> content.add(GUARD_SPIDER_SPAWN_EGG));
    }
}
