...
/**
 * <b style="color:FFC800"><font size="+2">Register：喷吐毒蛛服务端注册器</font></b>
...
public class Register {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(SRItemGroup.MISC).register(content -> content.add(SPRAY_POISON_SPIDER_SPAWN_EGG));
        // 注册毒素与毒素粒子
